...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // Creality Ender-3 Pro
  #define DEFAULT_bedKp 117.77
  #define DEFAULT_bedKi 20.99
  #define DEFAULT_bedKd 440.63
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 406.1, 414.8 }
...
// Force the use of the probe for Z-axis homing NO HACE FALTA ACTIVAR, ya lo hace Z_MIN_PROBE_USES_Z_MIN_ENDSTOP_PIN
